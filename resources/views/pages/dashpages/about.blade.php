		  ...
		  <header id="header">
	  			...
	  			<div class="container">
			  		<div class="row align-items-center">
			  			<div class="col-lg-6 col-sm-6 col-4 header-top-left">
			  				<a href="tel:+9530123654896"><span class="lnr lnr-phone-handset"></span> <span class="text"><span class="text">+509 37424643</span></span></a>
				  			<a href="mailto:support@colorlib.com"><span class="lnr lnr-envelope"></span> <span class="text"><span class="text">isb@2018.iceberg@gmail.com</span></span></a>			
			  			</div>
		    ...
		    <div class="container main-menu">
		    	<div class="row align-items-center justify-content-between d-flex">
			      <div id="logo">
			        <a href="index.html" class="nw-btn primary-btn circle">SANTE HAITI</a>
			      </div>
			      <nav id="nav-menu-container">
			        <ul class="nav-menu">
			          ...
			          <li><a href="features.html">Services</a>
					   <ul>
			              <li><a href="departments.html">Hopitals</a></li>
			              <li><a href="elements.html">Pharmacies</a></li>
						    <li><a href="blog-single.html">Cliniques</a></li>
							 <li><a href="doctors.html">Médecins</a></li>
			            </ul></li></li>
			        ...
			        <!-- <li><a href="doctors.html">Doctors</a></li>
			          ...
			          <li class="menu-has-children"><a href="">Information</a>
			            <ul>
			              <li><a href="blog-home.html">Fitness</a></li>
			              <li><a href="blog-single.html">Forum</a></li>
			            </ul>
			          </li>	
		                ...
		                <div class="col-lg-3 col-md-6 single-team">
		                    <div class="thumb">
		                        ...
		                        <div class="align-items-end justify-content-center d-flex">
		                            ...
		                            <h4>ROYER Stephanie Mitchely Jemina</h4>		                            
		                        </div>
		                    </div>
		                </div>
		                <div class="col-lg-3 col-md-6 single-team">
